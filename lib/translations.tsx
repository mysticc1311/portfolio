export const translations = {
  en: {
    ...
    contact_message_placeholder: 'Hi Mattia, I wanted to...',
    contact_send_button: '📤 Send',
    contact_find_title: 'Or find me at',
    contact_sent_title: 'Message sent!',
    contact_sent_desc: "Thanks for reaching out. I'll get back to you soon.",
  ...
  it: {
    ...
    contact_name_placeholder: 'Mario Rossi',
    contact_email_label: 'Email',
    contact_email_placeholder: 'mario@esempio.it',
    contact_message_label: 'Messaggio',
    contact_message_placeholder: 'Ciao Mattia, volevo...',
    contact_send_button: '📤 Invia',
    contact_find_title: 'Oppure trovami su',
    contact_sent_title: 'Messaggio inviato!',
    contact_sent_desc: 'Grazie per avermi contattato. Ti risponderò al più presto.',
    contact_send_another: 'Invia un altro',
  },
};